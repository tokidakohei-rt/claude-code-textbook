...
または [公式サイト](https://nodejs.org) からダウンロードしてください。
...
好きなフォルダに移動（例: ホームディレクトリ）してからクローンします:
...
または Node.js のバージョン管理ツール [nvm](https://github.com/nvm-sh/nvm) を使うのがおすすめです。
...
v18 未満の場合はアップデートが必要です。nvm を使っている場合:
